        ...
        <Table size="medium" aria-label="a dense table">
          ...
          <TableBody>
            {friendArray.map((friend) => (
              ...
              >
                <TableCell align="right">{friend.user.id_pseudo}</TableCell>
                <TableCell align="left">
                  <Avatar src={friend.user.avatar} />
                </TableCell>
                <TableCell align="left">
                  <ButtonGroup size="small" variant="contained">
                    {friend.user.status === "IN GAME" ? (
                      <Button
                        color="info"
                        onClick={() => onClickWatch(context.user, friend.user)}
                      >
                        Watch
                      </Button>
                    ) : null}
                    {friend.user.status === "ONLINE" ? (
                      <Button
                        ...
                        onClick={() => onClickDefy(context.user, friend.user)}
                      >
                        Defy
                      </Button>
                    ) : null}
